            ...
            <div className="w-full md:w-1/2 flex items-center justify-center p-8">
                <div className="max-w-md w-full">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold text-gray-800 mb-2">Join as a Supplier</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all pr-20"
                                ...
                                <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex space-x-2">
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${fetchingLocation ? 'animate-pulse' : ''}`} viewBox="0 0 20 20" fill="currentColor">
                            ...
                            {/* Map component */}
                            {showMap && (
                                <div className="mt-3 relative rounded-lg overflow-hidden border border-gray-300 shadow-md">
                                    <div
                                        ref={mapRef}
                        ...
                        <button
                            type="submit"
                            className="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium rounded-lg shadow transition-all duration-300 transform hover:translate-y-[-2px]"
                        >
                            Create Account
                        </button>
                    </form>
            ...
            <div className="hidden md:block md:w-1/2 bg-cover bg-center" style={{ backgroundImage: `url(${banner})` }}>
                <div className="w-full h-full flex items-end p-10 bg-gradient-to-t from-black/70 via-black/30 to-transparent">
                    <div className="text-white max-w-lg">
                        <h2 className="text-4xl md:text-5xl font-bold mb-4">Quality Materials, <br /><span className="text-blue-300">Solid Results</span></h2>
                        <p className="text-gray-200 text-lg">Join our marketplace and connect with contractors looking for quality construction materials.</p>
                    </div>
                </div>
            </div>
        </div>
