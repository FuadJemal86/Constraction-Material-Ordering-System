...
function Header() {
    ...
    return (
        <div>
            ...
            {/* Banner Section */}
            <section className="relative w-full h-[70vh] min-h-[500px] bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 dark:from-gray-900 dark:via-gray-800 dark:to-black rounded-bl-[40px] rounded-br-[40px]">
