    ...
    return (
        <div>
            ...
            <div className='w-full overflow-x-hidden'>
                {/* Hero Section */}
                <section className="relative w-full h-[60vh] min-h-[400px] bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 dark:from-gray-900 dark:via-gray-800 dark:to-black rounded-bl-[40px] rounded-br-[40px]">
