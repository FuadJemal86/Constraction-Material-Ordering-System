...
CREATE TABLE `order` (
    ...
    `deliveryOption` VARCHAR(191) NOT NULL,
...
CREATE TABLE `product` (
    ...
    `deliveryPricePerKm` DOUBLE NULL,
...
-- AddForeignKey
ALTER TABLE `payment` ADD CONSTRAINT `Payment_transactionId_fkey` FOREIGN KEY (`transactionId`) REFERENCES `order`(`transactionId`) ON DELETE RESTRICT ON UPDATE CASCADE;
